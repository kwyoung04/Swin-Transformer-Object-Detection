...
model = dict(
    type='CascadeRCNN',
    pretrained='/home/ubuntu/src/swint/work_dirs/nia_zeron/swin_base_patch4_window7_224_22k.pth',
    backbone=dict(
...
data_root = '/home/ubuntu/data/train/fix_test/'
...
log_level = 'INFO'
load_from = None
#resume_from = '/home/ubuntu/src/swint/work_dirs/latest.pth'
resume_from = None
workflow = [('train', 1)]
fp16 = None
work_dir = '/home/ubuntu/src/swint/work_dirs/'
gpu_ids = range(0, 8)
