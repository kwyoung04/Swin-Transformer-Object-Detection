ANNO_FILE = "/home/ubuntu/src/swint/Merge_COCO_FILES/0_1_3.json"

model = dict(
    type='CascadeRCNN',
    pretrained=
    '/home/ubuntu/swint/Swin-Transformer-Object-Detection/swin_base_patch4_window7_224_22k.pth',
    backbone=dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=ANNO_FILE,
        img_prefix='/home/ubuntu/data/train/images/',
...
log_level = 'INFO'
load_from = None
resume_from = '/home/ubuntu/src/swint/zerontech_221206_nia_epoch_43.pth'
workflow = [('train', 1)]
fp16 = None
